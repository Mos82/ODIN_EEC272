...
module spi_slave #(
   ...
   (* mark_debug = "true" *)    output reg                  SPI_GATE_ACTIVITY,
    ...
    always @(posedge SCK)
   (* mark_debug = "true" *)        spi_shift_reg_in <= {spi_shift_reg_in[18:0], MOSI};
