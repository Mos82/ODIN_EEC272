...
module ODIN #(
    ...
    // Controller
   (* mark_debug = "true" *)  wire                 CTRL_READBACK_EVENT;
   (* mark_debug = "true" *)  wire                 CTRL_PROG_EVENT;
   (* mark_debug = "true" *)  wire [      2*M-1:0] CTRL_SPI_ADDR;
   (* mark_debug = "true" *)  wire [          1:0] CTRL_OP_CODE;
   (* mark_debug = "true" *)  wire [      2*M-1:0] CTRL_PROG_DATA;
    wire [          7:0] CTRL_PRE_EN;
    wire                 CTRL_BIST_REF;
   (* mark_debug = "true" *)  wire                 CTRL_SYNARRAY_WE;
   (* mark_debug = "true" *) wire                 CTRL_NEURMEM_WE;
