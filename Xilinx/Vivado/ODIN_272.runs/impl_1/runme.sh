...
HD_PWD='E:/vivado_projects/ODIN_272/ODIN_272.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ODIN_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ODIN_design_wrapper.tcl -notrace
