...
HD_PWD='E:/vivado_projects/ODIN_272/ODIN_272.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ODIN_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ODIN_design_wrapper.tcl
