...
#
# Script generated by Vivado on Sat Apr 27 02:24:15 -0700 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ODIN_design.sh
...
#
# Usage        : ODIN_design.sh
#                ODIN_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ODIN_design.sh [-reset_run]
#                ODIN_design.sh [-reset_log]
#                ODIN_design.sh [-help]
#
...
#                script (type 'ODIN_design.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ODIN_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../ODIN_272.gen/sources_1/bd/ODIN_design/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../ODIN_272.gen/sources_1/bd/ODIN_design/ipshared/aed8/hdl" +incdir+"../../../../ODIN_272.gen/sources_1/bd/ODIN_design/ipshared/ec67/hdl" +incdir+"../../../../ODIN_272.gen/sources_1/bd/ODIN_design/ipshared/aed8/hdl" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ODIN_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ODIN_design -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ODIN_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ODIN_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ODIN_design.sh [-help]\n\
Usage: ODIN_design.sh [-step]\n\
Usage: ODIN_design.sh [-lib_map_path]\n\
Usage: ODIN_design.sh [-reset_run]\n\
Usage: ODIN_design.sh [-reset_log]\n\
Usage: ODIN_design.sh [-keep_index]\n\
Usage: ODIN_design.sh [-noclean_files]\n\n\
