...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ODIN_design xil_defaultlib.glbl -o ODIN_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ODIN_design_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ODIN_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ODIN_design_simv.daidir vcs_lib c.obj)
